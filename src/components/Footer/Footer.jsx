        ...
        <div className="mx-auto w-full max-w-[72.875rem] px-4 xl:px-0">
          <div className="flex flex-col justify-between sm:px-[1.125rem] md:flex-row md:px-10">
            <div className="md:w-[19.75rem]">
              <p className="text-[1.125rem] font-medium text-white"></p>
              <h1 className="text-white font-extrabold">
                <span className="text-black dark:text-[#009DDC]">LINKO</span>
                BRACELET
              </h1>
              <p />
              <p className="mt-[1.125rem] text-[.9375rem] font-normal text-white/[80%]">
                LINKO Bracelet is designed to support your health every day —
                reminding you to take your medications, tracking vital signs,
                and keeping loved ones informed in real time.
              </p>
            ...
            <div className="md:w-[19.75rem]">
              <div className="mt-[1.4375rem] flex">
                ...
                <div className="ml-[1.125rem]">
                  <Link
                    to="tel:+911800123444"
                    className="font-Inter text-[.875rem] font-medium text-white"
                  >
                    +201111111111
                  </Link>
                  <p className="font-Inter text-[.75rem] font-medium text-white">
                    Support Number
                  </p>
                </div>
              </div>
              <div className="mt-[1.4375rem] flex">
                ...
                <div className="ml-[1.125rem]">
                  <Link
                    to="mailto:help@lorem.com"
                    className="font-Inter text-[.875rem] font-medium text-[#fff]"
                  >
                    LinkoBracelet@gmail.com
                  </Link>
                  <p className="font-Inter text-[.75rem] font-medium text-[#fff]">
                    Support Email
                  </p>
                </div>
              </div>
            ...
            <div className="mt-6 flex w-full flex-col justify-between text-white sm:flex-row md:mt-0 md:max-w-[21.3125rem]">
              <div className>
                <p className="text-deutziawhite font-inter text-[1.125rem] font-medium leading-normal">
                  Pages
                </p>
                <ul>
                  <li className="mt-[.9375rem]">
                    <Link
                      className="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[.9375rem] font-normal hover:font-semibold"
                      to="/"
                    >
                      Home
                    </Link>
              ...
              <div className="mt-6 flex flex-col gap-4 sm:mt-0">
                <p className="text-deutziawhite font-inter text-[1.125rem] font-medium">
                  Download the app
                </p>
