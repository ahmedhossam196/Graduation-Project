...
<div className="flex gap-4">
  ...
  <Link className="hover:scale-110" target="_blank" to="https://www.linkedin.com/">
    <i className="fa-brands fa-linkedin text-white text-2xl"></i>
  </Link>
  <Link className="hover:scale-110" target="_blank" to="https://www.instagram.com/">
    <i className="fa-brands fa-instagram text-white text-2xl"></i>
  </Link>
  <Link className="hover:scale-110" target="_blank" to="https://x.com/">
    <i className="fa-brands fa-x-twitter text-white text-2xl"></i>
  </Link>
  <Link className="hover:scale-110" target="_blank" to="https://www.youtube.com/">
    <i className="fa-brands fa-youtube text-white text-2xl"></i>
      ...
      <div className="md:w-[19.75rem]">
        <div className="mt-[1.4375rem] flex">
          <div className="flex h-[2.375rem] w-[2.375rem] items-center justify-center rounded-[75%]">
        ...
        <div className="mt-[1.4375rem] flex">
          ...
          <div className="ml-[1.125rem]">
            <Link to="mailto:help@lorem.com" className="font-Inter text-[.875rem] font-medium text-[#fff]">IAEMS,6 october city ,Egypt</Link>
            <p className="font-Inter text-[.75rem] font-medium text-white">Address</p>
          </div>
        </div>
      </div>
      <div className="mt-6 flex w-full flex-col justify-between text-white sm:flex-row md:mt-0 md:max-w-[21.3125rem]">
        <div className>
          <p className="text-deutziawhite font-inter text-[1.125rem] font-medium leading-normal">Pages</p>
          <ul>
            <li className="mt-[.9375rem]"><Link className="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[.9375rem] font-normal hover:font-semibold" to="/">Home</Link></li>
            <li className="mt-[.9375rem]"><Link className="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[.9375rem] font-normal hover:font-semibold" to="/our-tutors">News</Link></li>
            <li className="mt-[.9375rem]"><Link className="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[.9375rem] font-normal hover:font-semibold" to="/become-Link-tutor">Contact</Link></li>
            <li className="mt-[.9375rem]"><Link className="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[.9375rem] font-normal hover:font-semibold" to="/plans-and-pricing">Plans and pricing</Link></li>
            <li className="mt-[.9375rem]"><Link className="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[.9375rem] font-normal hover:font-semibold" to="/terms-and-conditions">Terms and conditions</Link></li>
            <li className="mt-[.9375rem]"><Link className="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[.9375rem] font-normal hover:font-semibold" to="/privacy-policy">Privcay policy</Link></li>
          </ul>
        </div>
        <div className="mt-6 flex flex-col gap-4 sm:mt-0">
          <p className="text-deutziawhite font-inter text-[1.125rem] font-medium">Download the app</p>
          <div className="flex gap-4 sm:flex-col">
            <Link target="_blank" to="#"><img alt="facebook icon" loading="lazy" width={168} height={50} decoding="async" data-nimg={1} className='rounded-md' style={{color: 'transparent'}} src={googlePlay} /></Link><Link target="_blank" to="#"><img alt="facebook icon" loading="lazy" width={168} height={50} decoding="async" data-nimg={1}  className="rounded-md" style={{color: 'transparent'}} src={AppStore} /></Link>
          </div>
        </div>
      </div>
    </div>
    <hr className="mt-[1.875rem] text-white" />
